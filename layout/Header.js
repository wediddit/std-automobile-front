  ...
  const list = (anchor) => (
    ...
    >
      ...
      <Stack direction={"column"} spacing={1} alignItems={"flex-start"}>
        ...
        {/* <Link href={"/our-ads"} style={{ textDecoration: "none" }}>
          <ButtonHeader
            sx={{
              color: `${router.pathname == "/our-ads" ? "white" : "black"}`,
              backgroundColor: `${
                router.pathname == "/our-ads" ? "black" : "white"
              }`,
              "&:hover": {
                backgroundColor:
                  router.pathname == "/our-ads" ? "black" : "grey.light",
              },
            }}
          >
            Nos annonces
        ...
        <Link href={"/delivery"} style={{ textDecoration: "none" }}>
          <ButtonHeader
            ...
            sx={{
              ...
              backgroundColor: `${
                router.pathname == "/delivery" ? "black" : "white"
              }`,
              "&:hover": {
                backgroundColor:
        ...
        <Link href={"/recovery"} style={{ textDecoration: "none" }}>
          <ButtonHeader
            ...
            sx={{
              ...
              backgroundColor: `${
                router.pathname == "/recovery" ? "black" : "white"
              }`,
              "&:hover": {
                backgroundColor:
        ...
        <Link href={"/contact"} style={{ textDecoration: "none" }}>
          <ButtonHeader
            ...
            sx={{
              ...
              backgroundColor: `${
                router.pathname == "/contact" ? "black" : "white"
              }`,
              "&:hover": {
                backgroundColor:
        ...
        {authMethods.isConnected(auth) && (
          ...
          >
            <ButtonHeader
              ...
              sx={{
                color: `${
                  router.pathname == "/dashboard/add-ad" ? "white" : "black"
                }`,
                backgroundColor: `${
                  router.pathname == "/dashboard/add-ad" ? "black" : "white"
                }`,
                "&:hover": {
                  backgroundColor:
        ...
        {authMethods.isConnected(auth) && (
          ...
          >
            <ButtonHeader
              ...
              sx={{
                color: `${
                  router.pathname == "/dashboard/all-ads" ? "white" : "black"
                }`,
                backgroundColor: `${
                  router.pathname == "/dashboard/all-ads" ? "black" : "white"
                }`,
                "&:hover": {
                  backgroundColor:
